...
cascade = cv2.CascadeClassifier(r"S:\Vehicle-Number-Plate-Detection-and-Recognition-main\Vehicle Number Plate Detection and Recognition\haarcascade_russian_plate_number.xml")
...
extract_num(r"Vehicle Number Plate Detection and Recognition\sample3.webp")